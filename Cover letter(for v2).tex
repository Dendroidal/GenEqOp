...
\begin{itemize}
	...
	\item[15.] Clarified references and definition of semi-model structures we are using. 
	%In particular, we are using the (relative) notion as described in \cite{WY15}, and added a footnote comparing this to the stronger notion of a $J$-semi-model structure from \cite{Spi01}.
	...
	of $J$-semi-model structure in \cite{Spi01}
	...
	Namely, the \emph{definition} of the $J$-semi-model structures of \cite{Spi01}
...
%        The relevant observation is that the proof of \cite[Thm. 2]{Spi01} is completely analogous to the proof of \cite[Thm. 11.3.2]{Hi03}.
	...
	For clarify, we hence spelled out the ``natural analogue result'' of \cite[Thm. 11.3.2]{Hi03} we had in mind
