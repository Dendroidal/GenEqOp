...
\item[15.] Clarifed references and definition of semi-model structures.
...
\item[71.] Added a comment referencing Spitzweck's Theorem 2 and its relation to the desired analogue.
...
\item[78.] added Remark \ref{CSPP_REM} to address conditions similar to cofibrant symmetric pushout powers

\item[79.] added Definition \ref{GENUINEMS_DEF} and modified Remark \ref{GENCOFGEN REM} in \S \ref{MAINEXIST SEC}, and added Remark \ref{CSPP_REM} to \S \ref{PUSHPOW SEC} to emphasis genuine vs projective model structures.
