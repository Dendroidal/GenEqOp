...
\begin{itemize}
	...
	but we do not have a strong objection to changing it.
        ...
        \item[7.] Gave a heuristic definition of the $G$-action on the norm $N^X R$, as well as a formal definition using the graph subgroup $\Gamma_X$.
  ...
  \item[13.] Formally defined the $H$-action on $\O(X)$ as the restriction of $\O(n)$ along the map $H \to \Gamma_X \leq G \times \Sigma_n$.
