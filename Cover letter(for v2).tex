...
\begin{itemize}
  ...
  \item[69.] Expanded Remark \ref{GEN_FGTRIGHT_REM} to include information and results concerning
        ...
        Added Example \ref{F_ALL_EX} to \S \ref{PUSHPOW SEC} to be referenced in the expanded remark.

        Modified the introduction to \S \ref{FAMILY_SEC} to match these edits.
        
  \item[71.] Spitzweck's notion of a $J$-semi-model structure from \cite{Spi01} includes as part of the \textit{definition}
        ...
        To circumvent this digression, we have added to our parenthetical comment a reference to \cite[Thm. 2]{Spi01} and its similar proof.
