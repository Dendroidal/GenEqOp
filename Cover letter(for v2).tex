...
\begin{itemize}
	...
	\item[13.] Formally defined the $H$-action on $\O(X)$
	via graph subgroups 
...
\item[56.] 
in Definition \ref{LABMAP DEF} we added a reference to \eqref{TVGE DEF} where the notation $T_{v_{Ge}}$ first appears.
