...
%	
	...
	and of Batanin-Berger in {\color{red} ref}
	...
	\cite{BM03} and {\color{red} ref} need not worry about
	(more detail below).
	To properly compare the approaches, we summarize them below:
\begin{itemize}
	\item[(i)] the approach in 
	\cite[\S 5.11]{BM03}
	directly describes filtrations as in
	...
	{\color{red} ref}.
	Also of relevance for this approach is Caviglia's work in Appendices B,C {\color{red} ref},
	which adapts the Berger-Moerdijk filtration 
	to the colored case, while also providing a more detailed discussion than in \cite{BM03}.
\item[(ii)] poly monads		
\end{itemize}	
	...
	For example, our $\widehat{\Omega}^e_G$ 
	category
	
	Berger-Moerdijk admissible is different
