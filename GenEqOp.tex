...
\begin{remark}
      ...
      is sufficient for the construction of a variety of projective model structures
      ...
      COME BACK
      The power cofibration axiom is very demanding, leading to a number of more general variants
      (e.g. \cite[Thm. 6.1.1 $(\clubsuit)$]{WY18}, \cite[Defn. 2.1 and Thm. 1.1]{DS18})).
      However, neither the power cofibration axiom or any of these variants see any fixed-point information in $\V^{\Sigma_n}$, and thus cannot be used to prove our main results.
