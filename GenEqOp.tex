...
\begin{definition}
	A morphism $S \xrightarrow{\varphi} T$ in $\Omega$ preserving the planar structure $\leq_p$
...
\subsection{Root, leaf-root and vertex functors}\label{LRVERT SEC}
...
\todo[inline]{reordering not complete - future referencing}
...
\begin{proof}
	This is a minor adaptation of the non-equivariant analogues Proposition \ref{SUBDATAUNDERPLANG PROP} and Corollary \ref{SUBDATAUNDERPLAN COR}.
            \todo{this seems to be both self-referential and future referential}
...
In preparation for our discussion of the substitution operation in \S \ref{SUBS SEC}, we now recall some basic notions and results concerning outer subtrees and tree grafting, as in \cite[\S 5]{Pe17}.
