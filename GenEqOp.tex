...
\abstract{We build new algebraic structures, which we call genuine equivariant operads and which can be thought of as a hybrid between equivariant operads and coefficient systems.
