...
(\ref{SUBSDATUMTREES EQ}) and Propositions \ref{SUBDATAUNDERPLAN PROP},\ref{SUBDATAUNDERPLANG COR}, 
...
To describe the monad structure on $\mathbb{F}_G$, however, we will find it preferable to separate the left Kan extension in (\ref{FGXDEF EQ})
