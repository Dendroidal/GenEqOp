...
\end{tikzcd}	
\]
defining the left vertical functors (with the right functors being analogous) in the commutative diagrams below.
...
The following is a reinterpretation of Proposition \ref{SUBDATAUNDERPLANG COR}.
