...
As is standard practice (e.g \cite{SS00, Spitz01, BM03, Whi14, Pe16}),
...
The desired filtration (\ref{}) of the map $\P \to \P[u]$ will be induced by a
suitable filtration on this category $\bar{\Omega}_G^e$.
The accessable description of this filtration then allows us to transfer
the model structures on $\Sym^G_\F$ and $\Sym_\F$ to the categories of algebras $\Op^G$ and $\Op_\F$
using the technology of \cite{SS00}. 
The detailed cofibrancy analysis of these model structures, as well as their comparison and the proofs of our main result, are addressed in \S \ref{COFIB SEC}. 
...
Summarizing the results in the previous subsection, 
we have that the free $\mathbb{F}_G$-extension $\P[u]$ defined by the pushout
...
We will now use this description to a build a filtration of the map $\P \to \P[u]$ in the category $\Sym_G(\V)$. 
