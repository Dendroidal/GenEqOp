...
model category of equivariant dendroidal sets encoding $G$-$\infty$-operads from \cite[Theorem 2.1]{Pe17}, and 
...
While genuine equivariant (colored) operads as defined in this paper
do not explicitly appear in \cite{Pe17,BP_edss,BP_HGOP,BP_TAS},
$G$-trees and the algebra and combinatorics of genuine equivariant operads play a prominent role.
%
