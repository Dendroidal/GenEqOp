...
between $\mathcal{F}$-trees match the pullback 
...
\begin{remark}\label{COMPADJ REM}
	...
	$\Sigma_G^{\text{fr}} \nsubset \Sigma_{\mathcal{F}}$ (the most interesting case being that of $\Sigma_{G}^{\geq 1} \hookrightarrow \Sigma_G$ the corollas of arity $\geq 1$, which model non-unital operads),
