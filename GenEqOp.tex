...
\begin{equation}
\begin{tikzcd}
	\Omega^1 \ar{d}[swap]{d_1} \ar{rr} &&
	|[alias=Vtt]|
	\Fin \wr \Omega \ar{r} \ar[equal]{d} &
	\mathcal{V} \ar[equal]{d}
&
	\Omega^1 \ar[equal]{d} \ar{rrr} &&&
	|[alias=Vtt2]|
	\Fin \wr \Omega \ar[equal]{d} \ar{r} &
	\mathcal{V} \ar[equal]{d}
\\
	|[alias=FVt]|
	\Omega^0 
...
&
	...
	\Omega^1 
	\ar{r} \ar{d}[swap]{d_1}&
	\Fin \wr \Omega^0 \ar{r} \ar{d}[swap]{d_0} &
	|[alias=Vt2]|
	\Fin^{\wr 2} \wr \Omega \ar{r}{\sigma^0} \ar[equal]{d} &
	\Fin \wr \Omega \ar{r} \ar[equal]{d} &
	\mathcal{V} \ar[equal]{d}
\\
	|[alias=FV]|
...
&
	...
	|[alias=FV2]|
	\Fin \wr \Sigma \ar{r} &
	\Fin^{\wr 2} \wr \Omega \ar{r}{\sigma^0} &
	\Fin \wr \Omega \ar{r} &
	\mathcal{V}
...
\begin{tikzcd}[column sep=1.05em]
	\Omega^1 \ar[equal]{d} \ar{r} &
	\Fin \wr \Omega^0 \ar{r} \ar[equal]{d}&
	\Fin \wr \Omega \ar{r}{\delta^1} &
	|[alias=dog2]|
	\Fin^{\wr 2} \wr \Omega \ar{r} \ar[equal]{d} &
	\Fin^{\wr 2} \wr \mathcal{V}^{op} \ar{r}{\otimes} \ar[equal]{d} &
	\Fin \wr \mathcal{V}^{op} \ar{r}{\otimes} \ar[equal]{d}&
	\mathcal{V}^{op} \ar[equal]{d} &
\\
	\Omega^{1} \ar{r} \ar{d}[swap]{d_{0}} &
	|[alias=cat2]|
	\Fin \wr \Omega^0 \ar{r} &
	|[alias=FFOmega]|
	\Fin^{\wr 2} \wr \Sigma \ar{r} \ar{d}{\sigma^0} &
	\Fin^{\wr 2} \wr \Omega \ar{d}{\sigma^0} \ar{r} &
	|[alias=cat3]|
...
\\
	...
	\Fin \wr \Omega \ar{r} &
	|[alias=cat]|
	\Fin \wr \mathcal{V}^{op} \ar{rr}[swap]{\otimes} &&
	\mathcal{V}^{op}
...
\begin{equation}
\begin{tikzcd}
	\Omega^0 \ar[equal]{d} \ar{r} &
	\Omega \ar{r} &
	|[alias=Vt]|
	\Fin \wr \Omega \ar[equal]{d}
&
	\Omega^1 \ar[equal]{d} \ar{r} &
	\Omega \ar{r} &
	|[alias=Vt2]|
...
&
	...
	\Fin \wr \Sigma \ar{r} &
	\Fin \wr \Omega 
\arrow[Leftarrow, from=Vt, to=FV, shorten <=0.10cm,shorten >=0.10cm,"\epsilon_0"]
\arrow[Leftarrow, from=Vt2, to=FV2, shorten <=0.10cm,shorten >=0.10cm,"\epsilon_1"]
\arrow[Leftarrow, from=Vt3, to=FV3, shorten <=0.10cm,shorten >=0.10cm,"\beta"]
\end{tikzcd}
\end{equation}
...
\begin{equation}
\begin{tikzcd}[column sep=1.05em]
	\Omega^1 \ar[equal]{d} \ar{rr} &&
	|[alias=dog]|
	\Fin \wr \Omega \ar{d} \ar{r}{\delta^1} &
	\Fin^{\wr 2} \wr \Omega \ar[equal]{d}
\\
	|[alias=cat]|
	\Omega^1 \ar[equal]{d} \ar{r} &
	\Fin \wr \Omega^0 \ar{r} \ar[equal]{d}&
...
\\
	...
	|[alias=FFOmega]|
	\Fin^{\wr 2} \wr \Sigma \ar{r} \ar{d}{\sigma^0} &
	\Fin^{\wr 2} \wr \Omega \ar{d}{\sigma^0} 
\\
	|[alias=Omega]|
	\Omega^{0} \ar{rr} &&	
	\Fin \wr \Sigma \ar{r} &
...
versus $X_1 \xrightarrow{d_0} X_0 \xrightarrow{\epsilon} N X_{-1}$
