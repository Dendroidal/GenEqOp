...
&
	\mathbb{F} Y \mathbin{\check{\amalg}} \mathcal{P}
	\ar[dashed]{l}
\end{tikzcd}
\end{equation}
...
The category $\Omega_G^e$ of \textit{extensions} trees 
...
Lemma \ref{OUTERFACEUNION LEM} guarantees that the $V_G(U_k^{X})$ are disjoint, and applying 
Proposition \ref{BUILDABLE PROP}(iii)
one builds a planar tall map
