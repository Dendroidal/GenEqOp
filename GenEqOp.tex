...
well-defined up to conjugation\index{graph subgroups!graphsub@$\Gamma_X \leq G \times \Sigma_n$}. 
Next,
using the natural 
...
\index{Grothendieck fibrations!1GrothendieckFibration@$\pi \colon \mathcal{E} \to \mathcal{B}$}
if, for every arrow 
