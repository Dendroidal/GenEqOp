...
If moreover $\V$ is underlying strongly cellular, each of these are actual model structures.
\end{customthm}
...
\todo[inline]{come back: gen cofibs, Q equivs, etc}
...
\begin{theorem} 
  ...
  For $\V$ Cartesian underlying strongly cellular, % and moreover
  % \begin{itemize}
