...
\begin{notation}\label{UEUPE NOT}
	...
	as simply
	$U_{e^{\uparrow} \leq e}$\index{structure on trees!vertices!UEUPE@$U_{e^{\uparrow} \leq e}$}.
\end{notation}
...
\begin{notation}\label{UEUPEG NOT}
	...
	S_{v_{Ge}} = 
	\left(S_{\varphi(f^{\uparrow}) \leq \varphi(f)}\right)_{f \in Ge}.\index{structure on trees!vertices!SVGE@$S_{v_{Ge}}$}
	\end{equation}
\end{notation}
