...
We now address why (\ref{GENGEINFTY EQ}), rather than 
(\ref{NAIVEGEINFTY EQ}), provides the correct up-to-homotopy replacement for $\mathsf{Comm}$ in the equivariant context.
