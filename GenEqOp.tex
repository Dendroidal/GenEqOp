...
\begin{align*}
	\mathcal{P} \coprod_{\mathbb{F} X} \mathbb{F} Y \simeq &
...
\begin{proposition}
All the analogue statements of Proposition \ref{PIIPROP PROP}
hold for the 
$\Omega_{G}^{n,s,\lambda}$
and the 
$\Omega_{G}^{n,s,\lambda} \wr (A_j)$
...
\[
	d_i \wr \Omega_G^{n,\bullet,\lambda} \simeq d_i 
\phantom{m}
	\pi_i \wr \Omega_G^{n,\bullet,\lambda} \simeq \pi_i 
\phantom{m}
	s_j \wr \Omega_G^{n,\bullet,\lambda} \simeq s_j 
\phantom{m}
