...
{\color{red} \S \ref{MAINEXIST SEC}} in parallel with Theorem \ref{MAINEXIST1 THM}.
...
yields that the required conditions need only be independently checked for the
