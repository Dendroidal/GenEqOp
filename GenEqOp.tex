...
In order to encode the homotopical information inspired by $N_\infty$-operads discussed in the introduction, 
we will introduce and transfer several associated (semi) model structures on the categories $\Op_G(\V)$ and $\Op^G(\V)$ for a wide range of $\V$. 
...
\begin{definition} 
      ...
      is the unique (semi) model structure with projective genuine weak equivalences, fibrations, and cofibrations.        
