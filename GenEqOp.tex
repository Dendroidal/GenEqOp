...
$\O(n) \to \O'(n)$
is $G$-equivalence after forgetting the $\Sigma_n$-actions, 
i.e. if the maps
...
\end{cases}
\end{equation}
However, as first noted by Costenoble-Waner in \cite{CW91},
...
\begin{proof}
We note first that the claim concerning the symmetric sequence adjunction of (\ref{COFADJ EQ})
...
For the operad adjunction in (\ref{COFADJ EQ}),
