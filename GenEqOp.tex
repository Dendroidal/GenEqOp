...
(and hence this adjoint restricts to an inclusion of a reflective subcategory $\Op^{G \cap \F}(\V)$ of those $\O \in \Op^G(\V)$ such that $\O(C) = \varnothing$ for all $C\notin \Sigma_\F$).
...
\end{corollary}  
\begin{proof} 
        As $\upgamma_!$ preserves pushouts of operads by (\ref{TWOADJOINTSOPF EQ},
