...
\end{tikzcd}
\end{equation} 
Here $\mathsf{sOp}_{\bullet}^G$
is the model category of $G$-equivariant colored operads
...
(where $\Omega$ is the category of trees)
...
(notably, 
\cite{BP_edss} uses an alternative description of genuine operads 
\cite[Def. 3.35]{BP_edss}; see Theorem \ref{NERVE THM}).
...
Just like usual operads,
genuine operads admit a notion of algebra.
A full formal definition of such algebras is forthcoming, 
...
conjecture Elmendorf Piacenza for algebras
