...
\subsection{Remarks on general monads}

Given a monad $T$ on $\C$ one immediately obtains a monad
$T^{\times 2}$ on $\C^{\times 2}$.

\begin{proposition}\label{MONADICFUN PROP}
	Consider the adjunction
\[
	\amalg \colon \C^{\times 2}
	\rightleftarrows
	\C \colon \Delta	
\]
Then there is a monadic functor ({\color{red} check terminology})
\begin{equation}\label{TPOWERMONFUN EQ}
T^{\times 2} \to \Delta \circ T \circ \amalg.
\end{equation}
\end{proposition}

\begin{proof}
We first note that there are natural isomorphisms
$T^{\times 2} \circ \Delta \simeq \Delta \circ T$ and 
$(T \circ S)^{\times 2} \simeq T^{\times 2} \circ S^{\times 2}$ which are compatible in the sense that the composite isomorphism
$T^{\times 2} \circ S^{\times 2} \circ \Delta \simeq
T^{\times 2} \circ \Delta \circ S \simeq
\Delta \circ T \circ S$ matches
$(T \circ S)^{\times 2} \circ \Delta \simeq \Delta \circ T \circ S$.
(\ref{TPOWERMONFUN EQ}) is then the composite
\[
	T^{\times 2} \xrightarrow{\eta} 
	T^{\times 2} \circ \Delta \circ \amalg \simeq
	\Delta \circ T \circ \amalg.
\]
The multiplicative condition is the commutativity of the diagram
\[
\begin{tikzcd}
	T^{\times 2} \circ T^{\times 2} \ar{d} \ar{r} &
	\Delta \circ T \circ \amalg \circ \Delta \circ T \circ \amalg \ar{d} 
\\
	T^{\times 2} \ar{r} &
	\Delta \circ T \circ \amalg.
\end{tikzcd}
\]
Recalling that $(\minus) \circ \amalg$ is the right adjoint to 
$(\minus) \circ \Delta$ this follows from the diagram
\[
\begin{tikzcd}
	T^{\times 2} \circ \Delta \circ \amalg \circ T^{\times 2} \circ \Delta \ar{r} &
		T^{\times 2} \circ \Delta \circ \amalg \circ \Delta \circ T \ar{rd}{\epsilon}
\\
	T^{\times 2} \circ T^{\times 2} \circ \Delta \ar{u}{\eta} \ar{r} \ar{d}&
	T^{\times 2} \circ \Delta \circ T \ar[equal]{r} \ar{u}{\eta} &
	T^{\times 2} \circ \Delta \circ T \ar{r} &
	\Delta \circ T \circ T \ar{d}
\\
	T^{\times 2} \circ \Delta \ar{rrr} &&&
	\Delta \circ T
\end{tikzcd}
\]
{\color{red} Add a unit argument.}
\end{proof}


\begin{remark}
	Since $T \circ \amalg$ is a right $\Delta \circ T \circ \amalg$-module, it is likewise a right $T^{\times 2}$-module.
\end{remark}
