...
The top differentials $d_n$ have natural transformation given by
\begin{equation}
...
$d_i$ for $0 \leq i \leq n$ are given by
\begin{equation}
	\begin{tikzcd}[column sep=3.7em]
...
\\
	...
	\end{tikzcd}
\end{equation}
where $\pi_i^{(A)}$ interchanges lexicographic orders and $\alpha_i$ is the natural associativity isomorphism.
...
\begin{equation}
	...
	\Fin \wr \coprod \Fin^{\wr n-1} \wr \Omega_{G,0}^{(A)} \ar{r}{F_1} \ar{d}&
	|[alias=dog2]|
...
\begin{equation}
	...
	|[alias=dog2]|
	\Fin \wr \coprod \Fin^{\wr n} \wr A \ar{r}{F} \ar{d}{\sigma^1}&
