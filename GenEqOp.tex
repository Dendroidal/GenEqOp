...
then says that $\mathbb{F}_G \mathbb{F}_G X$ roughly consists of ``planar tall maps of $G$-trees $T_0 \to T_1$ with $G$-nodes of $T_1$ labelled by $X$'' (for a precise statemen, see Remark \ref{REPACKAGERES REM}),
so that the monad multiplication
