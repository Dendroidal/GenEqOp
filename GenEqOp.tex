...
Lastly, (d) is argued by induction on $k$ and $n$
...
\begin{tikzcd}[row sep=1.7em,column sep = 2.5em]
	...
	\ar{d}{d_{i-1}} &
	\Omega_G^n \ar{r}{V_G} &
	\Fin_s \wr \Omega_G^{n-1} \ar{r}{V_G^k} &
	\Fin_s^{\wr 2} \wr \Omega_G^{n-k-2} \ar{r}{\sigma_0} &
	\Fin_s \wr \Omega_G^{n-k-2}
\\
...
\begin{tikzcd}
	\Omega_G^n \ar{r}{V_G} &
	\Fin_s \wr \Omega_G^{n-k} \ar{r}{V_G^k} &
	\Fin_s^{\wr 2} \wr \Omega_G^{n-k-l-2} \ar{r}{\sigma_0} &
	\Fin_s \wr \Omega_G^{n-k-l-2}
\end{tikzcd}
\]
