...
\begin{remark}\label{COLEREDGEN REM}
	...
	In \cite{BP_edss} we an alternative description 
...
The key ingredient needed to obtain Conjecture \ref{EPGEN CONJ}
...
\begin{remark}\label{ALGELMCOL REM}
	...
	Theorem \ref{MAINQUILLENEQUIV THM} 
	in fact verifies Conjecture \eqref{EPGEN CONJ}
	for the operad $\mathcal{T}^{\mathsf{fr}}_G$. 
	
	For some extra detail, 
	including a more precise description of $\mathcal{T}^{\mathsf{fr}}_G$ ,
	see Remark \ref{SOMEMOREDET REM},
	which discusses the role the map
	$\mathcal{T} \to \mathcal{T}^{\mathsf{fr}}_G$ 
