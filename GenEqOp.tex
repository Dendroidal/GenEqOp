...
In the remainder of the proof we abbreviate
$\mathcal{P} = \iota_{\**} \mathcal{O}$, so that 
$(\iota_{\**} \mathcal{O})[\iota_{\**} u] = \mathcal{P}[\iota_{\**} u]$.
The previous paragraphs can then be summarized as saying that,
...
is an isomorphism, 
and can thus be checked by forgetting to $\Sym_G(\V)$.
...
As such, and in light of the already established
