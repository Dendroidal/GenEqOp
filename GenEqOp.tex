...
recovering the definition of semi-model structure in 
\cite[\S 12.1]{Fre09}
(the purpose of choosing other $\mathcal{M}$ 
being that the existence of the
semi-model structure on $\mathcal D$ therein
is usually established via transfer from $\mathcal{M}$).},
...
This section will establish some useful properties of the $\mathcal{V}^G_{\mathcal{F}}$ model structures. We start by strengthening the 
