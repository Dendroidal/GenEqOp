...
\begin{definition}\label{SUBSTITUTIONDATUMG DEF}
	...
	by $\mathsf{Sub}_{\mathsf{r}}(T)$ (resp. $\mathsf{Sub}_p(T)$).
\end{definition}
...
\\
	...
	T \downarrow \Omega_{G}^{\mathsf{pt}} \ar[l,shift left=2pt] \ar{u}[swap]{\pi^{\**}} &
	\mathsf{Sub}_{\mathsf{r}}(T) \ar[r,shift left=2pt] \ar{u}{(\pi_{Ge})} &
	T \downarrow \Omega_{G}^{\mathsf{rt}} \ar[l,shift left=2pt] \ar{u}[swap]{\pi^{\**}}
\end{tikzcd}
\end{equation}
\end{remark}
