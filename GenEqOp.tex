...
\begin{remark}\label{CSPP_REM}
	...
	the latter axiom suffices to establish the existence
	...
	is quite restrictive (for example, it fails in $\mathsf{sSet}$),
	and this has lead to a number of laxer variants
	(e.g. 
