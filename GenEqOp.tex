...
\begin{itemize}
	...
	\item[(ii)] fixed points $(\minus)^H$ preserve pushouts where one leg is $(G/K)\cdot f$, for $f$ a cofibration in $\mathcal V$;
...
\begin{proposition}\label{STRONGCELL PROP}
	...
	\begin{itemize}
		\item[(i)] $(\minus)^H \colon \mathcal{V}^G \to \mathcal{V}$ preserves cofibrations and pushouts where one leg
			 is a genuine cofibration in $\mathcal V^G$;
