...
\begin{remark}
	The image of $\iota_{\**}$ consists of genuine equivariant operads whose mapping spaces for non-free $G$-trees are suitable fixed points of the mapping spaces for free $G$-trees.

By contrast, if one uses $\iota_!$ to regard $\mathsf{Op}^G$ as a coreflexive subcategory of $\mathsf{Op}_G$, 
	one obtains the far less interesting
	subcategory of genuine equivariant operads whose mapping spaces are empty for non-free trees.
