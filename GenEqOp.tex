...
\begin{tikzcd}[column sep=1em]
	\Omega_{G}^0 \ar[equal]{d} \ar{r} &
	|[alias=dog2]|
	\Fin \wr \Sigma_{G} \ar{r}&
	\Fin \wr \Omega^0_{G} \ar{r} &
	\Fin \wr \mathcal{V}^{op} \ar{r} &
	\mathcal{V}^{op} \ar[equal]{d} 
\\
	|[alias=cat2]|
	\Omega_{G}^0 \ar{rrrr} \ar{d}[swap]{d_{0}} 
	\ar{rru} &&&&
	|[alias=dog3]|
	\mathcal{V}^{op} \ar[equal]{d}
\\
	...
	|[alias=cat]|
	\mathcal{V}^{op} 
\arrow[Leftarrow, from=dog3, to=Omega,shorten <=0.15cm,shorten >=0.15cm]%,"\pi_0"]
\arrow[Rightarrow, from=dog2, to=cat2,shorten <=0.15cm,shorten >=0.15cm]
\end{tikzcd}
\end{equation}
