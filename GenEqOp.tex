...
\begin{proof}
        ...
        \]
        preserves genuine cofibrations. Thus, it suffices to show that $f^{\Box V_G(T)}$ is cofibrant on the right hand side. This follows immediately by Proposition \ref{AUTTCOFPUSH PROP} and Remark \ref{GENUINE_FGTRIGHT_REMARK}.
        % \[
