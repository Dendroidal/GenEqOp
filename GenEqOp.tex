...
(where $G$ acts on $\mathcal{T} \times G$
via the trivial action on $\mathcal{T}$ and the conjugation action on $G$)
\[
\mathcal{T} \times G \to \mathcal{T}_G^{fr}
\]
Moreover, this map is essentially surjective an
naively fully faithful.
